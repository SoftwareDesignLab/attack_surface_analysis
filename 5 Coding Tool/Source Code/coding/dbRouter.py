# DB Router for `db_coding` app
DB_NAME = "db_coding"
APP_LABEL ='coding'

class CodingDBRouter(object):
    """
    ...
    def db_for_read(self, model, **hints):
        """Send all read operations on Example app models to DB_NAME."""
        if model._meta.app_label == APP_LABEL:
            return DB_NAME
        return None

    def db_for_write(self, model, **hints):
        """Send all write operations on Example app models to DB_NAME."""
        if model._meta.app_label == APP_LABEL:
            return DB_NAME
        return None
